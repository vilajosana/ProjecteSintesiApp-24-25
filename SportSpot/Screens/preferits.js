...
const styles = StyleSheet.create({
  ...
  labelButton: {
    backgroundColor: '#FF6347',  // Mantenim la tonalitat taronja
    paddingVertical: 15,
  ...
  labelText: {
    fontSize: 18,
    color: '#fff',  // Text blanc per a contrastar amb el fons taronja
    fontWeight: 'bold',
    textAlign: 'center',
  },
  loadingText: {
    fontSize: 18,
    textAlign: 'center',
    color: '#888',  // Text gris per a mostrar l'estat de càrrega
    marginTop: 20,
  },
  favItem: {
    padding: 15,
    backgroundColor: '#f8f8f8',  // Fons suau per a cada item
    marginBottom: 10,
    borderRadius: 8,
    borderLeftWidth: 5,
    borderLeftColor: '#FF6347',  // Vora esquerra en color taronja
    shadowColor: '#000',
  ...
  favItemText: {
    fontSize: 18,
    fontWeight: '600',
    color: '#333',  // Text fosc per una millor llegibilitat
  },
  footer: {
    width: '100%',
